...
Функция СформироватьПечатнуюФормуКО1(МассивОбъектов, ОбъектыПечати)
	...
	|	""50.01""                                            КАК КодДебета
	//{ds-28.03.2021
	|	,ЕСТЬNULL(ПриходныйКассовыйОрдер.КассаККМ.Магазин.ds_НеВыводитьПрефиксВКассовыхДокументах,
	|		ЕСТЬNULL(ПриходныйКассовыйОрдер.Касса.Магазин.ds_НеВыводитьПрефиксВКассовыхДокументах, ЛОЖЬ)) КАК НеВыводитьПрефикс
	//}
	|ИЗ
	|	Документ.ПриходныйКассовыйОрдер КАК ПриходныйКассовыйОрдер
	|ГДЕ
