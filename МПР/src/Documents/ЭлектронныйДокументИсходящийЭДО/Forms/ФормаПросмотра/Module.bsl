...
&НаСервере
Процедура EF_00_00451787_ПодготовитьПредставлениеФайла(ЭлементСхемыРегламента)
...
Процедура ПодготовитьПредставлениеФайла(ЭлементСхемыРегламента)
	...
	Если ЗначениеЗаполнено(ЭлементСхемыРегламента.ПрисоединенныйФайл)Тогда
		Элементы.ГруппаКомандДобавитьЗаменить.Видимость = Ложь;
		Элементы.ДобавитьВложениеИзФайлаНаДискеОдиночная.Видимость = Ложь;
	ИначеЕсли EF_00_00451787_КоличествоПрисоединенныхФайлов() > 0 Тогда
		Элементы.ГруппаКомандДобавитьЗаменить.Видимость = Истина;
		Элементы.ДобавитьВложениеИзФайлаНаДискеОдиночная.Видимость = Ложь;
	Иначе
		Элементы.ГруппаКомандДобавитьЗаменить.Видимость = Ложь;
...
&НаСервере
Функция EF_00_00451787_КоличествоПрисоединенныхФайлов()
	
	ВладелецПрисоединенныхФайлов = EF_00_00451787_ВладелецПрисоединенныхФайлов();
...
&НаСервере
Функция EF_00_00451787_ВладелецПрисоединенныхФайлов()
