...
Процедура ВыполнитьРегламентноеЗаданиеРасчетСебестоимости() Экспорт
	...
	ВыполнитьРасчетСебестоимости(ПрошлыйМесяц, МассивМагазинов);
	
	ПозапрошлыйМесяц = НачалоМесяца(ПрошлыйМесяц) - 1;
	ВыполнитьРасчетСебестоимости(ПозапрошлыйМесяц, МассивМагазинов);
	//}
