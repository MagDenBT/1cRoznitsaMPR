...
Процедура ПриОткрытии(Отказ)
	...
	//{ds-02.07.2021
	Если ЗначениеЗаполнено(Объект.ds_СтатусИнтернетЗаказа) Тогда
...
&НаКлиенте
Процедура ds_СтатусИнтернетЗаказаПриИзменении(Элемент)
	Элементы.Статус.Доступность = НЕ ЗначениеЗаполнено(Элемент.ТекстРедактирования);
КонецПроцедуры
...
Процедура ds_ПолучитьЗагруженныеТоварыИзХранилища(РезультатВыбора)
	...
	ОбработкаТабличнойЧастиТоварыСервер.ЗаполнитьПризнакИспользованияХарактеристик(Объект[ИмяТЧ]);
