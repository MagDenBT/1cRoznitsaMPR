...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(СертификатОбъект) Экспорт
	...
	СодержаниеЗаявления = СертификатОбъект.СодержаниеЗаявления.Получить();
	...
	Если ТипЗнч(СодержаниеЗаявления) = Тип("Структура") Тогда
		...
		Если СодержаниеЗаявления.Свойство("ДатаОбновленияСостояния") Тогда
			Если (СертификатОбъект.СостояниеЗаявления = Перечисления.СостоянияЗаявленияНаВыпускСертификата.Исполнено
				Или СертификатОбъект.СостояниеЗаявления = Перечисления.СостоянияЗаявленияНаВыпускСертификата.ИсполненоРаспискаНеОтправлена
				Или СертификатОбъект.СостояниеЗаявления
			...
			ИначеЕсли СертификатОбъект.СостояниеЗаявления
		...
		ЗаписьНабораЗаявления.СодержаниеЗаявления = СертификатОбъект.СодержаниеЗаявления;
		ЗаписьНабораЗаявления.СостояниеЗаявления = СертификатОбъект.СостояниеЗаявления;
	...
	СертификатОбъект.СостояниеЗаявления = Неопределено;
