...
Процедура ТоварыРасширениеПриАктивизацииСтроки(Элемент)
	...
	Если ИмяТекущейСтраницы = "СтраницаТоварыРасширение" Тогда
		...
		//{ds
		Если ds_ОтображатьКартинку Тогда
			ds_Изображение = ds_ОбщегоНазначенияВызовСервера.ПолучитьИзображение(Элемент.ТекущаяСтрока, УникальныйИдентификатор);
		КонецЕсли;	
		//}		
	КонецЕсли;
...
Процедура УстановитьВидимостьКолонокТаблицыОстаткиЦены()
	...
	//{ds
	Если НЕ Элементы.ds_Изображение.Видимость = ds_ОтображатьКартинку Тогда
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
			Элементы,
			"ds_Изображение",
			"Видимость",
			ds_ОтображатьКартинку);
	КонецЕсли;
	//}
...
Процедура НадписьИнформацияНажатиеКлиент()
	...
	//{ds
	Элементы.ds_Изображение.Видимость = ПоказРасширения И ds_ОтображатьКартинку;
	//}
...
&НаКлиенте
Процедура ds_ОтображатьКартинкуТоварыРасширениеПриИзменении(Элемент)
