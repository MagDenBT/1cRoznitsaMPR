...
Функция ПолучитьПараметрыПечати(РежимПечати)
	...
	ПараметрыПечати.Вставить("ПодарочныеСертификаты", Объект.ПодарочныеСертификаты);
	ПараметрыПечати.Вставить("ДисконтныеКарты", Объект.ДисконтныеКарты);
	ПараметрыПечати.Вставить("РегистрационныеКарты", Объект.РегистрационныеКарты);
