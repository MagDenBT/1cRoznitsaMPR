...
Процедура EF_00_00451710_ПроверитьЗаписиТорговыеПредложенияТорговойПлощадки(Знач Отбор, Знач АдресРезультата = Неопределено) Экспорт
...
Процедура ПроверитьЗаписиТорговыеПредложенияТорговойПлощадки(Знач Отбор, Знач АдресРезультата)
	...
	//Патч+++
	ТаблицаСкидкиЗаОбъемПродажВидыЦен = Неопределено;
	Если СведенияОТорговомПредложении.Свойство("СкидкиЗаОбъемПродажВидыЦен") Тогда
		РезультатЗапросаСкидкиЗаОбъемПродажВидыЦен = СведенияОТорговомПредложении.СкидкиЗаОбъемПродажВидыЦен;
		ТаблицаСкидкиЗаОбъемПродажВидыЦен = РезультатЗапросаСкидкиЗаОбъемПродажВидыЦен.Выгрузить();
		ТаблицаСкидкиЗаОбъемПродажВидыЦен.Индексы.Добавить("Номенклатура");
	КонецЕсли;
	
	ТаблицаСкидкиПроцентСуммаВидыЦен = Неопределено;
	Если СведенияОТорговомПредложении.Свойство("СкидкиПроцентСуммаВидыЦен") Тогда
		РезультатЗапросаСкидкиПроцентСуммаВидыЦен = СведенияОТорговомПредложении.СкидкиПроцентСуммаВидыЦен;
		ТаблицаСкидкиПроцентСуммаВидыЦен = РезультатЗапросаСкидкиПроцентСуммаВидыЦен.Выгрузить();
		ТаблицаСкидкиПроцентСуммаВидыЦен.Индексы.Добавить("Номенклатура");
	КонецЕсли;
...
Функция EF_00_00451710_ПолучитьДанныеПубликации(Знач ИменаТаблиц, Знач Отбор) Экспорт 
...
Функция ПолучитьДанныеПубликации(Знач ИменаТаблиц, Знач Отбор)
