...
Процедура EF_00_00446439_НачатьПодписаниеРегистрационногоПакета1СЭДО(ОбработкаПродолжения, ДанныеПакета, ОтборСертификатов)
...
Процедура НачатьПодписаниеРегистрационногоПакета1СЭДО(ОбработкаПродолжения, ДанныеПакета, ОтборСертификатов)
	...
	КонтекстПодписания = EF_00_00446439_НовыйКонтекстПодписанияРегистрационногоПакета1СЭДО();
	...
	Оповещение = Новый ОписаниеОповещения("EF_00_00446439_ПослеЗаполненияПрограммыВСертификате", ЭтотОбъект, КонтекстПодписания);
	КриптографияБЭДКлиент.EF_00_00446439_ЗаполнитьПрограммуВСертификате(Оповещение, ДанныеНаПодпись);
	
КонецПроцедуры

Процедура EF_00_00446439_ПослеЗаполненияПрограммыВСертификате(РезультатЗаполнения, КонтекстПодписания) Экспорт
	...
	Оповещение = Новый ОписаниеОповещения("EF_00_00446439_ЗавершитьПодписаниеРегистрационногоПакета1СЭДО", ЭтотОбъект,
		КонтекстПодписания);
...
Процедура EF_00_00446439_ЗавершитьПодписаниеРегистрационногоПакета1СЭДО(РезультатПодписания, КонтекстПодписания) Экспорт
...
Функция EF_00_00446439_НовыйКонтекстПодписанияРегистрационногоПакета1СЭДО()
