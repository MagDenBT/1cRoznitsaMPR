...
//  Булево.
//
Функция ДоступноИнкасацияВУправлениеФискальнымУстройством() Экспорт
	
	Результат = Ложь;
	ИнкасацияДоступна = Результат; 
	СтандартнаяОбработка = Истина;
	МенеджерОборудованияВызовСервераПереопределяемый.ДоступноИнкасацияВУправлениеФискальнымУстройством(ИнкасацияДоступна, СтандартнаяОбработка);
	Результат = ?(СтандартнаяОбработка, Результат, ИнкасацияДоступна);
	Возврат Результат; 
