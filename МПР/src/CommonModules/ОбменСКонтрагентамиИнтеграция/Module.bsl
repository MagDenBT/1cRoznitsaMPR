...
Функция СостоянияАктуальныхДокументооборотов(ОбъектыУчета) Экспорт
	...
	ТекстыЗапросов.Добавить(ЭлектронныеДокументыЭДО.ЗапросСостоянийДокументов(
		"СостоянияДокументооборотов", "ВЫБРАТЬ АктуальныеЭлектронныеДокументы.ЭлектронныйДокумент ИЗ АктуальныеЭлектронныеДокументы").Текст);
	ТекстыЗапросов.Добавить(
		...
		|ИЗ
		|	АктуальныеЭлектронныеДокументы КАК АктуальныеДокументыЭДО
		|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ СостоянияДокументооборотов КАК СостоянияДокументооборотов
		|	ПО АктуальныеДокументыЭДО.ЭлектронныйДокумент = СостоянияДокументооборотов.Ссылка");
