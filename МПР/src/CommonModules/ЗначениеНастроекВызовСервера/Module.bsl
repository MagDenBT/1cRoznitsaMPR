...
Функция ПараметрыКассыККМ(КассаККМ) Экспорт
	...
	|	КассыККМ.НеПечататьБумажныйЧек
	|ИЗ
	...
	Если Выборка.Следующий() Тогда
		...
		Если НЕ ПараметрыКассыККМ.ИспользоватьБезПодключенияОборудования
			...
			ПараметрыКассыККМ.ПоддерживаетПроверкуКодовМаркировки = ОборудованиеЧекопечатающиеУстройстваВызовСервера.ФискальноеУстройствоПоддерживаетПроверкуКодовМаркировки(
