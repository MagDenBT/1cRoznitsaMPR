...
Процедура EF_00_00446439_ЗаполнитьПрограммуВСертификате(ОповещениеОЗавершении, ОписаниеДанных) Экспорт
	...
	ФормаЗаполненияПрограммы = ОткрытьФорму("Обработка.КриптографияБЭД.Форма.ЗаполнениеПрограммыВСертификате_",
