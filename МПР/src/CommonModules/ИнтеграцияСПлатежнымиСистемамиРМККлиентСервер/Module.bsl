...
Процедура НастроитьФормуПоВидуОплаты(Форма, ВидыОплат) Экспорт
	...
	НастройкиИнтеграции = ИнтеграцияСПлатежнымиСистемамиРМКВызовСервера.НастройкиТорговойТочки(СтрокиОплаты[0].Интеграция);
...
// АПК:1036 - проектное решение Подтв.
// 
Процедура НастроитьФормуПоИнтеграции(Форма, ОписаниеОшибки = "", ТекстДлительнойОперации = "") Экспорт
	...
	Если ТекущаяСтраница(Форма.Элементы.ГруппаОсновнаяСтраница) Тогда
	...
	ИначеЕсли ТекущаяСтраница(Форма.Элементы.ГруппаДлительнаяОперация) Тогда
	...
	ИначеЕсли ТекущаяСтраница(Форма.Элементы.ГруппаQRКод) Тогда
	...
	ИначеЕсли ТекущаяСтраница(Форма.Элементы.ГруппаПодтверждение) Тогда
	...
	ИначеЕсли ТекущаяСтраница(Форма.Элементы.ГруппаВыполняется) Тогда
		...
		Если Форма.ПлатежнаяСистема_НоваяЗаявка.КраткоеПредставлениеКоманд Тогда
			...
			Элементы.ФормаЗавершитьПринудительно.Заголовок	= ?(ЭтоПродажа, 
																	НСтр("ru = 'Подтв. оплату'"), 
																	НСтр("ru = 'Подтв. возврат'"));
	...
	ИначеЕсли ТекущаяСтраница(Форма.Элементы.ГруппаЗавершение) Тогда
	...
	ИначеЕсли ТекущаяСтраница(Форма.Элементы.ГруппаОшибка) Тогда
	...
	ИначеЕсли ТекущаяСтраница(Форма.Элементы.ГруппаОшибкаПолученияСтатуса) Тогда
