...
Процедура EF_00_00449278_ПроверитьКонтрагентаВ1СЭДОПриЗаписи(Источник, Отказ) Экспорт
	...
	Попытка
		...
		ФоновыеЗадания.Выполнить("РаботаСАбонентамиЭДО.ПроверитьКонтрагентаФоновоеЗадание", 
			Параметры, СтрШаблон("%1 %2", ПараметрыЗапуска.ИНН, ПараметрыЗапуска.КПП), НСтр("ru = 'Проверка подключения'"));
