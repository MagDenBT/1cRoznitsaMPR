...
Процедура НачатьЗагрузкуОперацийПоЯндексКассе(ВыводитьОкноОжидания = Ложь) Экспорт
	...
	ДлительнаяОперация = ИнтеграцияСЯндексКассойРТВызовСервера.НачатьЗагрузкуОперацийПоЯндексКассе(ПараметрыЗагрузки);
...
Процедура ЭлементФормыНастроекСоздание(Контекст, Элемент, СтандартнаяОбработка) Экспорт
	...
	ПараметрыФормы.Вставить("Основание", ИнтеграцияСЯндексКассойРТВызовСервера.ДанныеЭквайераПоУмолчанию());
