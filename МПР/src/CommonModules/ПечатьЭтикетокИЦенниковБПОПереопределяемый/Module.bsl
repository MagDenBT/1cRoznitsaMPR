...
Процедура ФормаПечатьЭтикетокИЦенниковПриСозданииНаСервере(Форма) Экспорт
	...
	Форма.Объект.ТорговыйОбъектБПО = ЗначениеНастроекПовтИсп.МагазинПоУмолчанию(Форма.Объект.ТорговыйОбъектБПО);
...
Функция ДанныеДляФормированияПечатныхФорм(ПараметрыПечати, ПоляДляЗаполнения) Экспорт
	...
	Возврат УправлениеПечатьюРТ.ДанныеДляФормированияПечатныхФорм(ПараметрыПечати, ПоляДляЗаполнения);
...
Функция МакетСхемыКомпоновкиДанных(ТипЦенника = "") Экспорт
	...
	Возврат УправлениеПечатьюРТ.МакетСхемыКомпоновкиДанных(ТипЦенника);
