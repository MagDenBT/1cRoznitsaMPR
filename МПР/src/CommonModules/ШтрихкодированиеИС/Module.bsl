...
Функция ДанныеПоШтрихкодамEAN(ШтрихкодыEAN, ПараметрыСканирования = Неопределено, GTINПотребительскихУпаковок = Неопределено) Экспорт
	...
	Если ТипЗнч(ШтрихкодыEAN) = Тип("ТаблицаЗначений") Тогда
		ДанныеПоШтрихкодамEAN = ШтрихкодыEAN;
	Иначе
		ДанныеПоШтрихкодамEAN = ШаблонДанныеПоШтрихкодамEAN();
...
Процедура ЗаполнитьСведенияПоШтрихкодамEAN(ДанныеПоШтрихкодам, ПараметрыСканирования, ДанныеКодовМаркировки = Неопределено) Экспорт
	...
	Для Каждого СтрокаДанных Из ДанныеКодовМаркировки Цикл
		...
		Если УникальныеШтрихкодыEAN[ШтрихкодДляПоиска] = Неопределено Тогда
			НоваяСтрока = ДанныеПоШтрихкодамEAN.Добавить();
			НоваяСтрока.ШтрихкодEAN = ШтрихкодДляПоиска;
			// Если сканирование выполняется в форме проверки и подбора, то заполнение данных штрихкода не требуется.
			Если НЕ ПараметрыСканирования.ИспользуетсяСоответствиеШтрихкодовСтрокДерева Тогда
				НоваяСтрока.ШтрихкодИсходный = СтрокаДанных.Штрихкод;
			КонецЕсли;
	...
	ИнформацияПоШтрихкодамEAN = ДанныеПоШтрихкодамEAN(ДанныеПоШтрихкодамEAN, ПараметрыСканирования, GTINПотребительскихУпаковок);
...
Функция ШаблонДанныеПоШтрихкодамEAN()
	...
	ДанныеПоШтрихкодамEAN.Колонки.Добавить("ШтрихкодИсходный",            Новый ОписаниеТипов("Строка"));
