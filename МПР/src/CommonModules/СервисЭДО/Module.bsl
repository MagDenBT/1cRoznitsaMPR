...
Функция ПодтвердитьПолучениеСообщения(КлючСинхронизации, ИдентификаторСообщения, КонтекстДиагностики) Экспорт
	...
	Возврат EF_00_00444695_ПодтвердитьПолучениеСообщения(КлючСинхронизации, ИдентификаторСообщения, КонтекстДиагностики);
	
КонецФункции

Функция EF_00_00444695_ПодтвердитьПолучениеСообщения(КлючСинхронизации, ИдентификаторСообщения, КонтекстДиагностики,
	ИстекСрокДействияМаркера = Ложь) Экспорт
	...
	ПараметрыВыполненияОперации.Метод = ИнтернетСоединениеБЭД.HTTPМетоды().GET;
	ПараметрыВыполненияОперации.Таймаут = 10;	
	Результат = ВыполнитьОперацию(ПараметрыВыполненияОперации, КонтекстДиагностики, ИстекСрокДействияМаркера);
...
//
Функция EF_00_00448079_ЕстьДоступКВебСервису1CЭДО(ПараметрыОперации, КонтекстДиагностики)
...
Функция ЕстьДоступКВебСервису1CЭДО(ПараметрыОперации, КонтекстДиагностики)
	...
	РезультатПроверки = МашиночитаемыеДоверенностиПовтИсп.EF_00_00448079_ЕстьДоступКВебСервису1CЭДО();
...
Функция EF_00_00448079_АдресРесурсаPing() Экспорт
	Возврат АдресРесурсаPing();
КонецФункции

Функция EF_00_00448079_ИдентификаторИнтеграционногоРешения() Экспорт
	Возврат ИдентификаторИнтеграционногоРешения();
КонецФункции
