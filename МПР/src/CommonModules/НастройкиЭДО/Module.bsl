...
// Возвращает текст запроса для дополнения переданной таблицы настройками отправки.
// 
// Параметры:
...
// Возвращаемое значение:
// 	Строка
Функция ТекстЗапросаДополнениеНастройкамиОтправки(ИмяИсходнойТаблицы, ПоляТаблицы, ПоляКлючаНастройки) Экспорт
	...
	ТекстЗапроса =
		...
		|	НастройкиОтправки.ВерсияФорматаУстановленаВручную КАК ВерсияФорматаУстановленаВручную,
	...
	Для Каждого Элемент Из ПоляКлючаНастройки Цикл
		УсловияСвязи.Добавить(СтрШаблон("%1 = НастройкиОтправки.%2", Элемент.Значение, Элемент.Ключ));
	КонецЦикла;
...
// Возвращает описание полей ключа настроек отправки, см. ТекстЗапросаДополнениеНастройкамиОтправки.
// 
// Возвращаемое значение:
// 	Структура:
// * Отправитель - Строка
