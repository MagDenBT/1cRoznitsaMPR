...
//{ds-16.02.2021
&НаКлиенте
Процедура ds_НовыйШтрихкод(Команда)
	
	НовыйШК = Лев(ВРег(Строка(Новый УникальныйИдентификатор)), 11);	
	
	НовыйШК = СтрЗаменить(НовыйШК, Символ(65), "1");
	НовыйШК = СтрЗаменить(НовыйШК, Символ(66), "1");
	НовыйШК = СтрЗаменить(НовыйШК, Символ(67), "1");
	НовыйШК = СтрЗаменить(НовыйШК, Символ(68), "1");
	НовыйШК = СтрЗаменить(НовыйШК, Символ(69), "1");
	НовыйШК = СтрЗаменить(НовыйШК, Символ(70), "1");
	
	ШтрихкодКарты = НовыйШК;
