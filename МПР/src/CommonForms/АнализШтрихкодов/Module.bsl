...
Функция ПолученШтрихкодИзСШК(Штрихкод) Экспорт
	...
	Возврат РаботаСоШтрихкодамиКлиентПереопределяемый.ПолученШтрихкодИзСШК(ЭтотОбъект, СтруктураРезультат);
...
&НаКлиенте
Процедура ПродолжитьОбработатьДанныеПоКодуКлиент(СтруктураПараметровКлиента) Экспорт
...
Процедура ЗаполнитьТаблицуШаблоновНаСервере()
	...
	ТаблицаШаблоновРегистрацииНовыхКарт = РаботаСоШтрихкодамиПереопределяемый.ШаблоныРегистрацииНовыхКарт();
